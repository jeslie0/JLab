...
* Definition
Let \(P:E \rightarrow B\) be a functor. A /cleavage/ of \(p\) is a choice, for each \(e \in E\) and \(u : b \rightarrow Pe\), of a single [[id:73fde245-85d2-4e0a-bc4c-ce37e9105069][cartesian arrow]] \(f:e' \rightarrow e\) such that \(Pf = u\).
** Cloven functors
